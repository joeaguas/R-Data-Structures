...
```{r}
names <- c('Jim', 'Rick', 'Stephen', 'James')
names
```
...
my_array <- array(
  ...
  # dimensions
  dim <- c(3,3,3),
  # dimnames, row col names
  dimnames <- list(c("ROW 1", "ROW 2", "ROW 3"), c("COL 1", "COL 2", "COL3"), c("MAT 1", "MAT 2", "MAT 3"))
)
my_array
```
...
my_factor <- factor(
  c("Blue", "Green", "Brown", "Blue", "Green", "Brown", "Grey")
)
my_factor
```
...
my_arr <- array(c(first_vector, second_vector), dim = c(3,3,2))
